...
// Brand-colored inline SVG icons (kept simple and recognizable)
const CIcon = () => (
  <svg viewBox="0 0 128 128" className="h-7 w-7" aria-hidden="true">
    <path fill="#283593" d="M115.4 30.7L67.1 2.9c-.8-.5-1.9-.7-3.1-.7-1.2 0-2.3.3-3.1.7l-48 27.9c-1.7 1-2.9 3.5-2.9 5.4v55.7c0 1.1.2 2.4 1 3.5l106.8-62c-.7-1.3-1.6-2.4-2.4-2.7z" />
    <path fill="#5C6BC0" d="M10.7 95.3c.5.8 1.2 1.5 1.9 1.9l48.2 27.9c.8.5 1.9.7 3.1.7 1.2 0 2.3-.3 3.1-.7l48-27.9c1.7-1 2.9-3.5 2.9-5.4V36.1c0-.9-.1-1.9-.6-2.8l-106.6 62z" />
...
const JavaIcon = () => (
  <svg viewBox="0 0 128 128" className="h-7 w-7" aria-hidden="true">
    <path fill="#0074BD" d="M47.6 98.6s-4.9 2.9 3.5 3.8c10.1 1.2 15.4 1 26.6-1.1 0 0 3 1.9 7.1 3.5-25.1 10.7-56.8-.6-37.2-6.2zM44.5 84.4s-5.5 4.1 2.9 4.9c10.8 1.1 19.4 1.2 34.2-1.7 0 0 2 2.1 5.3 3.2-30.4 8.9-64.2.7-42.4-6.4z" />
    <path fill="#EA2D2E" d="M70.7 60.2c6.2 7.1-1.6 13.5-1.6 13.5s15.7-8.1 8.5-18.3c-6.7-9.5-11.8-14.2 16-30.3 0 .1-43.9 11-22.9 35.1z" />
    <path fill="#0074BD" d="M97.1 109s3.6 3-4 5.3c-14.4 4.4-60 5.7-72.7.2-4.6-2 4-4.8 6.7-5.4 2.8-.6 4.4-.5 4.4-.5-5.1-3.6-32.7 7-14.1 10 50.9 8.3 92.8-3.7 79.7-9.6zM50 69.7s-23.2 5.5-8.2 7.5c6.3.8 19 .7 30.8-.3 9.6-.8 19.3-2.5 19.3-2.5s-3.4 1.5-5.9 3.1c-23.6 6.2-69.1 3.3-56-3.1 11-5.4 19.9-4.7 19.9-4.7zM91.6 92.9c24-12.5 12.9-24.4 5.1-22.8-1.9.4-2.8.7-2.8.7s.7-1.2 2.2-1.7c16.5-5.8 29.1 17.1-4.9 24.3.1.1.3-.2.4-.5z" />
    <path fill="#EA2D2E" d="M77.6 0s13.3 13.3-12.6 33.7c-20.8 16.4-4.8 25.8 0 36.5-12.1-10.9-21-20.5-15-29.4C58.6 27.6 83 21.3 77.6 0z" />
    <path fill="#0074BD" d="M52.5 128.1c23 1.5 58.4-.8 59.2-11.7 0 0-1.6 4.1-19.1 7.4-19.7 3.7-44.1 3.3-58.5.9 0 0 3 2.4 18.4 3.4z" />
  </svg>
);
...
const PuzzleIcon = () => (
  <svg viewBox="0 0 24 24" className="h-7 w-7" fill="none" stroke="hsl(var(--primary))" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
const BrainIcon = () => (
  <svg viewBox="0 0 24 24" className="h-7 w-7" fill="none" stroke="hsl(var(--secondary))" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
type Skill = {
  ...
  desc: string;
  details: string[];
  span?: string; // tailwind grid span classes for bento layout
};
...
const skills: Skill[] = [
  {
    ...
    details: ["Data types & control flow", "Functions, arrays & strings", "Intro to pointers", "Console programs"],
    span: "md:col-span-2",
  },
  {
    Icon: JavaIcon,
    ...
    details: ["Classes & objects", "Inheritance & encapsulation", "Loops & arrays", "Console apps"],
  },
  {
    Icon: PythonIcon,
    name: "Python",
    ...
    details: ["Syntax basics", "Lists, dicts & functions", "Planning ML basics next"],
  },
  {
    Icon: HtmlIcon,
    name: "HTML & Web",
    ...
    details: ["Semantic tags", "Forms & links", "Responsive basics", "Live deployment"],
    span: "md:col-span-2",
  },
  {
    Icon: PuzzleIcon,
        ...
        <Reveal>
          <div className="mb-14">
            ...
            <h2 className="text-balance text-3xl font-bold tracking-tight md:text-5xl">
              What I <span className="font-serif italic gradient-text-cool">know</span>
            </h2>
            <p className="mt-4 max-w-2xl text-muted-foreground">
              A snapshot of the tools, languages, and topics I'm working with right
              now — plus where I'm heading next.
            </p>
          </div>
        </Reveal>
                ...
                <HoverCardTrigger asChild>
                  ...
                  >
                    <div className="mb-4 flex items-start justify-between gap-3">
                      ...
                      >
                        <span className={`h-1.5 w-1.5 rounded-full ${levelDot[s.level] ?? levelDot.Interest}`} />
                        {s.level}
                      </span>
                    </div>
            ...
            <div className="relative grid gap-6 md:grid-cols-[auto,1fr] md:items-start md:gap-8">
              ...
              <div>
                ...
                <p className="text-balance leading-relaxed text-muted-foreground md:text-lg">
                  ...
                  <span className="font-medium text-foreground">Artificial Intelligence and Data Science</span>
                  {" "}— understanding how machines can learn from data and help
                  solve real problems. Alongside that, I'm building a strong
                  foundation in{" "}
                  <span className="font-medium text-foreground">basic web development</span>
